...
require (
	github.com/RobinUS2/tsxdb/rpc v0.0.0-20200826085733-b35bb2a44b93
	github.com/RobinUS2/tsxdb/telnet v0.0.0-20200826085733-b35bb2a44b93
	github.com/RobinUS2/tsxdb/tools v0.0.0-20200826085733-b35bb2a44b93
